...
namespace CallingBotSample.Bots
{
    public class CallingBot : ActivityHandler
    {
        ...
        {
            var message = "The online meeting could not be created";
            ...
            if (onlineMeeting != null)
            {
                ...
                if (statefullCall != null)
                {
                    ...
                    CallsState.Add(statefullCall.Id, statefullCall.State);
                    return await WaitForCallSuccess(statefullCall.Id);
                }
                message = "The online meeting was created, but the bot could not join the call";
            }
        ...
        private async Task<CallResult> WaitForCallSuccess(string callId)
        {
            ...
            while (true)
            {
                ...
                if (waitingTime.TotalSeconds > 15)
                {
                    result.Message = "Call could not be established (P15S)";
                    break;
                }
                ...
                case "joinscheduledmeeting":
                    ...
                    if (onlineMeeting != null)
                    {
                        ...
                        if (statefullCall != null)
                        {
                            ...
                            //CallsToHangUp.Add(statefullCall.Id, turnContext.Activity.GetConversationReference());
                            //CallsToHangUpObservable.Add(new CallToHangUp
                            //{
                            //    CallId = statefullCall.Id,
